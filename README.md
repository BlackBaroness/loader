...
```kotlin
dependencies {
    implementation("io.github.blackbaroness:loader-bootstrap-bungeecord:1.0.0")
    implementation("io.github.blackbaroness:loader-bootstrap-bukkit:1.0.0")
}
```
...
```kotlin
plugins {
    id("io.github.blackbaroness.loader.plugin") version "1.0.0"
}
```
