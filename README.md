...
```kotlin
dependencies {
    implementation("io.github.blackbaroness:loader-bootstrap-bungeecord:1.4.2")
    implementation("io.github.blackbaroness:loader-bootstrap-bukkit:1.4.2")
}
```
...
```kotlin
plugins {
    id("io.github.blackbaroness.loader.plugin") version "1.4.2"
}
```
